...
const FALLBACK = {
  ...
  tools: [
    ...
    { id: "wechat", name: "微信", description: "高效的沟通与协作入口", icon: "wechat", entryType: "http", primaryUrl: "https://weixin.qq.com/", localPath: "/Applications/WeChat.app", categoryId: "cat-common", tags: ["沟通"], isPinned: false, status: "active", sortOrder: 8 },
